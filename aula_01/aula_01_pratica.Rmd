...
### 1. Usando a funcao runif() gere 30 números aleatórios entre -5 e 5
### alternando a posicao dos argumentos da funcao.
...
# Alternando posicao dos argumentos
...
### 3. Crie uma funcao para fazer a soma de dois números: x e y
...
### 4. Crie uma funcao para simular a jogada de um dado de 6 faces.

```{r}
# Ajuda funcao sample
?sample

# Funcao para simular jogada de um dado (1 a 6)
jogar_dado <- function() {
...
### 5. Crie uma funcao para simular a jogada de dois dados de 6 faces cada.
### calcule a soma dos resultados

```{r}
# Funcao para simular jogada de dois dados
...
### 6. Crie uma funcao para simular a jogada de n dados de 6 faces cada.
### calcule a soma dos resultados

```{r}
# Funcao para simular jogada de n dados
