...
### 1. Vamos registrar as temperaturas máximas de uma semana para análise climática com média, máxima e mínima.
### Utilizar a função scan
...
### Utilizar a função readline. Validar a entrada.
...
### Limpo e disponível em "https://raw.githubusercontent.com/dayanebravo/LPA_R/refs/heads/main/aula_04/ObesityDataSet_raw_and_data_sinthetic.csv"
### Legenda das colunas: Gender: Gênero (Male/Female), Age: Idade em anos,
...
### NObeyesdad: Classificação de peso (Target)
    Calcular estatísticas básicas, gerar os gráficos de:
...
# Exportando para CSV
caminho_arquivo_csv <- "C:/Users/fiasi/OneDrive/TCD - Linguagem de Prog Aplicada R/aula_04/dados_obesidade_csv.csv"
write.csv(dados, file = caminho_arquivo_csv, row.names = FALSE)
```



### 4. Vamos explorar o dataset "mtcars" do R
### Vamos fazer gráficos para a Distribuição de Cilindradas (cyl)
