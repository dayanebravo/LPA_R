...
### 2. Crie um datafram estoque com
...
```
    ...
    a. Calcular a média de cada aluno utilizando for
    b. Identificar quais alunos tiveram média maior ou igual a 7
    c. Contar quantos alunos ficaram abaixo da média em cada **atividade**
